...
export const apps: App[] = [
  ...
  },
  {
    ...
    summary:
      '地図にピンを立てて、写真・メモ・訪問日を記録する旅の記録アプリ。行きたい場所のストックや、世界遺産・国立公園のコレクション、家族や友達との共有もできる。',
    description:
    ...
    features: [
      ...
      {
        title: '家族や友達と共有',
        body: 'Pro プランの方がグループを作って招待コードを送ると、ピンと写真をひとつの地図で共有できます。メンバーのピンに自分で撮った写真を追加することも。招待された方は無料プランのままでも参加できます。',
      },
    ],
    status: 'released',
